...
export const CustomerSelect = ({
    ...
    const filterCustomerOption = (
        ...
        const nameReadingMatch = normalizeForSearch(
            option.data.nameReading.toLowerCase()
        ).includes(normalizeForSearch(searchText))
        const companyMatch = option.data.company
            ? option.data.company.toLowerCase().includes(searchText)
            : false
